...
public:
    ...
    AnimatedBackgroundButton *AddPublication_BTN;
    QPushButton *DeletePublication_BTN;
    QQuickWidget *SpecialButtonTest;
    QFrame *DataFrame;
    ...
    void setupUi(QWidget *TestForm)
    {
        ...
        TestForm->resize(1000, 600);
        TestForm->setStyleSheet(QString::fromUtf8("#centralwidget{\n"
...
"	border-radius: 10px;\n"
"	border-color: qlineargradient(spread:pad, x1:0.0240385, y1:0.54, x2:1, y2:0.551, stop:0 rgba(156, 156, 156, 255), stop:0.153846 rgba(104, 104, 104, 255), stop:0.360577 rgba(187, 187, 187, 255), stop:0.725962 rgba(105, 105, 105, 255), stop:0.942308 rgba(132, 132, 132, 255));\n"
"	background-color: qlineargradient(spread:pad, x1:0.476, y1:0, x2:0.471, y2:1, stop:0.144231 rgba(41, 41, 41, 255), stop:0.389423 rgba(77, 77, 77, 255), stop:0.95192"
                        "3 rgba(16, 16, 16, 255));\n"
"}\n"
"\n"
"#MainWindow {\n"
...
"border: solid; \n"
"	background-color: qlineargradient(spread:pad, x1:0, y1:0.522273, x2:1, y2:0.614, stop:0 rgba(0, 0, 0, 255), stop:0.25 rgba(59, 59, 59, 255), stop:"
                        "0.456731 rgba(0, 0, 0, 255), stop:0.697115 rgba(61, 61, 61, 255), stop:1 rgba(0, 0, 0, 255));\n"
"border-width: 2px; \n"
"border-radius: 10px;\n"
"	border-color: qlineargradient(spread:pad, x1:0.0240385, y1:0.54, x2:1, y2:0.551, stop:0 rgba(156, 156, 156, 255), stop:0.153846 rgba(104, 104, 104, 255), stop:0.360577 rgba(187, 187, 187, 255), stop:0.725962 rgba(105, 105, 105, 255), stop:0.942308 rgba(132, 132, 132, 255));\n"
"}\n"
""));
        gridLayout_9 = new QGridLayout(TestForm);
...
"}"));
        ...
        AddPublication_BTN = new AnimatedBackgroundButton(ButtonFrame);
        ...
        DeletePublication_BTN->setProperty("gradient_top", QVariant(QColor(85, 170, 0)));
        DeletePublication_BTN->setProperty("gradient_bottom", QVariant(QColor(0, 85, 0)));
        DeletePublication_BTN->setProperty("gradient_highlight", QVariant(QColor(235, 255, 143)));
        DeletePublication_BTN->setProperty("gradient_middle", QVariant(QColor(18, 135, 90)));

        gridLayout_6->addWidget(DeletePublication_BTN, 0, 1, 1, 1);

        SpecialButtonTest = new QQuickWidget(ButtonFrame);
        SpecialButtonTest->setObjectName(QString::fromUtf8("SpecialButtonTest"));
        SpecialButtonTest->setMinimumSize(QSize(175, 40));
        SpecialButtonTest->setMaximumSize(QSize(175, 40));
        SpecialButtonTest->setBaseSize(QSize(175, 40));
        SpecialButtonTest->setStyleSheet(QString::fromUtf8(""));
        SpecialButtonTest->setResizeMode(QQuickWidget::SizeRootObjectToView);
        SpecialButtonTest->setSource(QUrl(QString::fromUtf8("qrc:/SpecialButtonWidget.qml")));

        gridLayout_6->addWidget(SpecialButtonTest, 0, 3, 1, 1);
        ...
        SizeButton = new QPushButton(TestForm);
        ...
        ExitButton = new QPushButton(TestForm);
    ...
    {
        TestForm->setWindowTitle(QCoreApplication::translate("TestForm", "Publication Organizer", nullptr));
        Search_BTN->setText(QCoreApplication::translate("TestForm", "Search", nullptr));
        ResetSearch_BTN->setText(QCoreApplication::translate("TestForm", "Reset", nullptr));
        SearchPublications_LBL->setText(QCoreApplication::translate("TestForm", "Search Publications", nullptr));
        EditPublication_BTN->setText(QCoreApplication::translate("TestForm", "PushButton", nullptr));
        AddPublication_BTN->setText(QCoreApplication::translate("TestForm", "PushButton", nullptr));
        DeletePublication_BTN->setText(QCoreApplication::translate("TestForm", "PushButton", nullptr));
        ProgramLabel->setText(QCoreApplication::translate("TestForm", "Publication Organizer", nullptr));
        MinimizeButton->setText(QCoreApplication::translate("TestForm", "PushButton", nullptr));
        SizeButton->setText(QCoreApplication::translate("TestForm", "PushButton", nullptr));
        ExitButton->setText(QCoreApplication::translate("TestForm", "PushButton", nullptr));
    } // retranslateUi
